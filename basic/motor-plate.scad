...
difference(){
	...
	union(){
		...
		translate([platelength/2,plateheight/2,0])rotate([45,0,0])translate([0,0,-motorcenterdia/2])cylinder(r=motorcenterdia/2+motorwall, h=bodywidth);
	translate([platelength/2+holespacing/2,plateheight/2+holespacing/2,0])rotate([45,0,0])translate([0,0,-screwheaddia/2])cylinder(r=screwheaddia/2+motorwall, h=bodywidth);
	translate([platelength/2-holespacing/2,plateheight/2+holespacing/2,0])rotate([45,0,0])translate([0,0,-screwheaddia/2])cylinder(r=screwheaddia/2+motorwall, h=bodywidth);
	translate([platelength/2+holespacing/2,plateheight/2-holespacing/2,0])rotate([45,0,0])translate([0,0,-screwheaddia/2])cylinder(r=screwheaddia/2+motorwall, h=bodywidth/2);
	translate([platelength/2-holespacing/2,plateheight/2-holespacing/2,0])rotate([45,0,0])translate([0,0,-screwheaddia/2])cylinder(r=screwheaddia/2+motorwall, h=bodywidth/2);
